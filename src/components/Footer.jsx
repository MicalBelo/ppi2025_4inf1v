...
return    (
        <footer className={styles.footer}>
            ...
            <div className={styles.meunome}>
                <p>Mical Ribeiro Belo de Oliveira</p>
            </div>

            <div className={styles.icons}>
                <a href="https://instagram.com/itsmicalbe" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://github.com/MicalBelo" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://wa.me/5584981651160" target="_blank" rel="noopener noreferrer">
